...
//			}
//			jobCafeRepository.save(jobCafe);
//			// 2. 
...
//	}
	...
	//jobCafeList
	@Override
	public Page<JobCafe> getJobCafeList(String searchKeyword, Pageable pageable) {
		if(searchKeyword != null && !searchKeyword.equals("")) {
			return jobCafeRepository.findByCafeNameContainingOrGuGunContaining(searchKeyword, searchKeyword, pageable);
		}else {
