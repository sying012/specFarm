...
//            System.out.println(objChk);
	...
	public String requestDetail(@PathVariable("srchTrprId") String srchTrprId, @PathVariable("srchTrprDegr") String srchTrprDegr, @PathVariable("srchTorgId") String srchTorgId) throws IOException, JSONException {
		// 1. URL을 만들기 위한 StringBuilder.
        StringBuilder urlBuilder = new StringBuilder("https://www.hrd.go.kr/jsp/HRDP/HRDPO00/HRDPOA60/HRDPOA60_2.jsp?authKey=iuetUvIPndgwsAJkxuhhvEb7GdhK6wvV&returnType=XML&outType=2"); /*Out Type 1: 리스트, 2: 상세*/
        ...
        String returnedData = makeCatList(urlBuilder);
